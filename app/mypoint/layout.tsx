...
export default function mypointLayout({ children }: { children: React.ReactNode }) {
  return (
    <>
      <div className="relative box-border block h-full w-full pt-20">
        <Swiper slidesPerView={3} freeMode={true}>
          <SwiperSlide><li role="presentation" className={styles.gnb_depth2_default}><Link href="/mypoint/pntHistory">포인트 내역</Link></li></SwiperSlide>
          <SwiperSlide><li role="presentation" className={styles.gnb_depth2_default}><Link href="/mypoint/cardManage">포인트카드 관리</Link></li></SwiperSlide>
          <SwiperSlide><li role="presentation" className={styles.gnb_depth2_default}><Link href="/mypoint/regAffiliatePntCard">제휴포인트 카드 관리</Link></li></SwiperSlide>
          <SwiperSlide><li role="presentation" className={styles.gnb_depth2_default}><Link href="/mypoint/pntGiftMain">포인트 선물</Link></li></SwiperSlide>
          <SwiperSlide><li role="presentation" className={styles.gnb_depth2_default}><Link href="/mypoint/convertPntList">포인트 전환</Link></li></SwiperSlide>
          <SwiperSlide><li role="presentation" className={styles.gnb_depth2_default}><Link href="/mypoint/savePoint">영수증으로 적립</Link></li></SwiperSlide>
          <SwiperSlide><li role="presentation" className={styles.gnb_depth2_default}><Link href="/mypoint/chgPntPwdCert">포인트 비밀번호 변경</Link></li></SwiperSlide>
        </Swiper>
      </div>
      {children}
    </>
