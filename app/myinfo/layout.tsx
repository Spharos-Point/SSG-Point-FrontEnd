...
export default function mypointLayout({ children }: { children: React.ReactNode }) {
    ...
    return (
        ...
        <div className="flex pt-[70px] box-border text-center ">
            ...
            <SwiperSlide>
                <li role="presentation" className={pathName === "/myinfo/cert" ? styles.gnb_depth2_active : styles.gnb_depth2_default}>
            ...
            <SwiperSlide>
                <li role="presentation" className={pathName === "/myinfo/withdrawal/leavePassword" ? styles.gnb_depth2_active : styles.gnb_depth2_default}>
